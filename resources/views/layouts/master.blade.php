...
<head>
    ...
    <!-- Slick -->
    <link rel="stylesheet" type="text/css" href="{{ asset('FE/assets/css/slick.min.css') }}">
...
<body>
            ...
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none"
                        href="mailto:info@company.com">hongduc@gmail.com</a>
                    <i class="fa fa-phone mx-2"></i>
                    <a class="navbar-sm-brand text-light text-decoration-none"
                        href="tel:010-020-0340">022-308-495-723</a>
                </div>
                <div>
    ...
    <!-- Main content -->
    <!-- Định nghĩa vùng thay đổi -->
    @yield('content')
    <!-- End main content  -->

    <!-- Start Footer -->
    <footer class="bg-dark mt-4" id="tempaltemo_footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="">Thể loại</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="/">Trang Chủ</a>
                        </li>
                        <li><a class="text-decoration-none" href="">About Us</a>
                        </li>
